        ...
        <div className="p-4 md:p-12 text-center lg:text-left">
          ...
          <div className="mt-6 pb-16 lg:pb-0 w-4/5 lg:w-full mx-auto flex flex-wrap items-center justify-between">
            {props.linkToLinkedIn && (
              <SocialLinkIcon socialSiteName="LinkedIn" faIcon={faLinkedin} link={props.linkToLinkedIn} />
            )}
            ...
            {props.linkToGitHub && (
              <SocialLinkIcon socialSiteName="GitHub" faIcon={faGithub} link={props.linkToGitHub} />
            )}
          </div>
        </div>
      </div>
